...
player.feedTamagotchi(olive);
player.medicateTamagotchi(olive);
player.knockOutTamagotchi(olive);

player.feedTamagotchi(blue);
player.medicateTamagotchi(blue);
player.knockOutTamagotchi(blue);
